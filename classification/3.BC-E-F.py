...
# Pozitif class (inverse frequency)
neg = (y_train == 0).sum()
pos = (y_train == 1).sum()
...
Classification Report:
           ...
           0       0.99      0.69      0.81   1110443
           1       0.05      0.78      0.09     23517

    accuracy                           0.69   1133960
   macro avg       0.52      0.73      0.45   1133960
weighted avg       0.97      0.69      0.80   1133960

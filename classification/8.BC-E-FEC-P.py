...
class AftershockClassifier(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.fc5(x)  # Sigmoid yok burada çünkü loss BCEWithLogits
        return x.squeeze()
...
Classification Report:
           ...
           0       0.99      0.69      0.82   1110443
           1       0.05      0.77      0.10     23517

    accuracy                           0.70   1133960
   macro avg       0.52      0.73      0.46   1133960
weighted avg       0.97      0.70      0.80   1133960
